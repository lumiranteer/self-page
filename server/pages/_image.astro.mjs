...
async function getConfiguredImageService() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      '../chunks/astro/assets-service_NqPbLqvz.mjs'
    ).then(n => n.Q).catch((e) => {
...
}, "/home/runner/work/self-page/self-page/node_modules/astro/components/Image.astro", void 0);
...
}, "/home/runner/work/self-page/self-page/node_modules/astro/components/Picture.astro", void 0);
...
const imageConfig = {"service":{"entrypoint":"astro/assets/services/sharp","config":{}},"domains":[],"remotePatterns":[],"endpoint":"astro/assets/endpoint/node"};
					...
					const outDir = /* #__PURE__ */ new URL("file:///home/runner/work/self-page/self-page/dist/client/");
